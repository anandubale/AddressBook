    ...
    class AddressBook
    {
        ...
        public void DuplicateChecker()
        {
            ...
            foreach (var element in DictName)
            {
                ...
                {
                    Console.WriteLine("Entered Person Name already exist in Addressbook in AddressBook::\n" + element.Key );
                }
                else
                {
                    string newName = name;
                    ...
                    DictName.Add(addressbookName, newContact);
                    Console.WriteLine("Duplicate checker passed contact added successfully.");
                }
            }
        }
